void RegisterAllStrippedInternalCalls()
{
	...
	//Start Registrations for type : UnityEngine.Terrain
		...
		void Register_UnityEngine_Terrain_get_preserveTreePrototypeLayers();
		Register_UnityEngine_Terrain_get_preserveTreePrototypeLayers();
		...
		void Register_UnityEngine_Terrain_get_normalmapTexture();
		Register_UnityEngine_Terrain_get_normalmapTexture();

		//UnityEngine.Terrain UnityEngine.Terrain::get_bottomNeighbor()
		void Register_UnityEngine_Terrain_get_bottomNeighbor();
		Register_UnityEngine_Terrain_get_bottomNeighbor();

		//UnityEngine.Terrain UnityEngine.Terrain::get_leftNeighbor()
		void Register_UnityEngine_Terrain_get_leftNeighbor();
		Register_UnityEngine_Terrain_get_leftNeighbor();

		//UnityEngine.Terrain UnityEngine.Terrain::get_rightNeighbor()
		void Register_UnityEngine_Terrain_get_rightNeighbor();
		Register_UnityEngine_Terrain_get_rightNeighbor();

		//UnityEngine.Terrain UnityEngine.Terrain::get_topNeighbor()
		void Register_UnityEngine_Terrain_get_topNeighbor();
		Register_UnityEngine_Terrain_get_topNeighbor();
	...
	//Start Registrations for type : UnityEngine.TerrainData
		...
		void Register_UnityEngine_TerrainData_IsHolesTextureCompressed();
		Register_UnityEngine_TerrainData_IsHolesTextureCompressed();
		...
		void Register_UnityEngine_TerrainData_Internal_ClearAlphamapDirtyRegion();
		Register_UnityEngine_TerrainData_Internal_ClearAlphamapDirtyRegion();
		...
		void Register_UnityEngine_TerrainData_Internal_MarkAlphamapDirtyRegion();
		Register_UnityEngine_TerrainData_Internal_MarkAlphamapDirtyRegion();
		...
		//System.Void UnityEngine.TerrainData::Internal_SetDetailScatterMode(UnityEngine.DetailScatterMode)
		void Register_UnityEngine_TerrainData_Internal_SetDetailScatterMode();
		Register_UnityEngine_TerrainData_Internal_SetDetailScatterMode();
		...
		//UnityEngine.DetailScatterMode UnityEngine.TerrainData::get_detailScatterMode()
		void Register_UnityEngine_TerrainData_get_detailScatterMode();
		Register_UnityEngine_TerrainData_get_detailScatterMode();

		//UnityEngine.RenderTexture UnityEngine.TerrainData::GetHolesTexture()
		void Register_UnityEngine_TerrainData_GetHolesTexture();
		Register_UnityEngine_TerrainData_GetHolesTexture();
		...
		void Register_UnityEngine_TerrainData_GetCompressedHolesTexture();
		Register_UnityEngine_TerrainData_GetCompressedHolesTexture();
